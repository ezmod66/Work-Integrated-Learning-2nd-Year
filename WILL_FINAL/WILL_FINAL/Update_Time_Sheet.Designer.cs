...
{
	partial class Update_Time_Sheet
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.btnSearchTimeSheet = new System.Windows.Forms.Button();
			...
			// btnSearchTimeSheet
			// 
			this.btnSearchTimeSheet.BackColor = System.Drawing.Color.White;
			this.btnSearchTimeSheet.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.btnSearchTimeSheet.Font = new System.Drawing.Font("MS Reference Sans Serif", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.btnSearchTimeSheet.Location = new System.Drawing.Point(392, 38);
			this.btnSearchTimeSheet.Name = "btnSearchTimeSheet";
			this.btnSearchTimeSheet.Size = new System.Drawing.Size(107, 27);
			this.btnSearchTimeSheet.TabIndex = 7;
			this.btnSearchTimeSheet.Text = "Search";
			this.btnSearchTimeSheet.UseVisualStyleBackColor = false;
			// 
			// txtTimeSheetID
			// 
			this.txtTimeSheetID.Location = new System.Drawing.Point(254, 12);
			this.txtTimeSheetID.Name = "txtTimeSheetID";
			this.txtTimeSheetID.Size = new System.Drawing.Size(245, 20);
			this.txtTimeSheetID.TabIndex = 6;
			// 
			// label13
			// 
			...
			this.label13.Text = "Enter Time Sheet ID:";
			// 
			// Update_Time_Sheet
			// 
			...
			this.Controls.Add(this.btnSearchTimeSheet);
			this.Controls.Add(this.txtTimeSheetID);
			this.Controls.Add(this.label13);
			this.Controls.Add(this.groupBox1);
			this.Name = "Update_Time_Sheet";
			this.Text = "Update_Time_Sheet";
		...
		private System.Windows.Forms.Button btnSearchTimeSheet;
